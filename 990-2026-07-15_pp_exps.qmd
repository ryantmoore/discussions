...
Am I really giving this talk?

\pause

>- in **England**?
>- with Summer School Dir from **Argentina**?
>- **today**?
>- right **now**?

\pause 

(If you need to leave, due to other extra-curricular responsibilities, I understand.)

## What Am I Doing Here??

\Large
As if this wasn't bad enough\ldots

\pause

The **standard**: the Harold Clarke lectures should inspire and _change the career trajectory of some of the world's best minds_
...
## ESS: Making Connections

\Large

\begin{centering}
Deep Essex-Waseda connections
\end{centering}
...
![](figs/990-waseda-plaque.png){width=35% fig-align="center"}
...
>- Draw out lessons for applied, community-based (and academic) research

# Ten Randomised Experiments in Public Policy
...
2. [Fire Inspectors Risk-Score Lists](https://thelabprojects.dc.gov/fire-risk-prediction)
...
- _Intervention_: Randomise federal health infrastructure spending, household insurance to Mexican households
...
\vspace{5mm}
[@kingakrav07; @kingakima09; @moore12]
...
- _Intervention_: Randomise whether 911 emergency callers talk to a nurse
- _Finding_: Reduced ambulance dispatches, transports; increased primary care visits
- _A Lesson_: Advocates matter. Even when seems impossible, there may be a way. Effects can be huge (40pp).
...
- _Intervention_: Randomised whether households due to recertify received a behaviourally-informed reminder letter
...
- _Intervention_: Randomised email with simplified decisions and present-framing future gains
- _Finding_: Improved contributions for those _already_ contributing, but 0 new contributors
- _A Lesson_: Human behaviour is sticky!
...
- _Intervention_: Randomised whether police officers wore body-cameras
...
- _Finding_: Scores predictive, lists promote exploration, coarse scores $\to$ reported violations
...
(why aren't _worst_ violations in data??)
...
>    - The raw data 
>    - But not the outcome!  
(keep outcome separate -- design _before_ analysis)
>    - The outcome, last time
>    - Be nice to the Data Use Agreement administrators!
>- Attend to ethics
